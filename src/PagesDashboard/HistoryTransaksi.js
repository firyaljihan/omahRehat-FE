...
export default class HistoryTransaksi extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "update") {
            let url = "http://localhost:8080/pemesanan/updateBooking/" + this.state.id
    ...
    render() {
        return (
            ...
            <h1 className="font-bold text-2xl text-black-700 ml-12 mb-4">History Transaksi</h1>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                ...
                                <form class="space-y-6" onSubmit={(event) => this.handleSave(event)}>
                                    <div>
                                        <label for="status_pemesanan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Status</label>
