        ...
        axios.post(url, data)
            ...
            .catch(error => {
                ...
                if (error.response.status === 500 || error.response.status === 404) {
                    window.alert("Failed to login OmahRehat");
                }
            })
    }
                ...
                <div class="flex">
                    <div class="w-1/2 bg-gray-200 text-left">
                        <form class="bg-gray-100 shadow-md rounded px-8 pt-6 p-8 m-24 mt-30" onSubmit={(e) => this.handleLogin(e)}>
                            <p class="text-gray-700 text-2xl font-bold mb-4 text-center">Login to OmahRehat</p>
                            <p class="text-gray-700 text-sm font-normal mb-6 text-center">Silahkan login untuk memesan kamar di Hotel OmahRehat</p>
                            <div class="mb-2">
